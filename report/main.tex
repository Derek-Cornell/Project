...
We target the ILI rows of \textbf{Table 3} in Nie et al., comparing supervised PatchTST against DLinear at horizons $T \in \{24, 36, 48, 60\}$ weeks with look-back $L = 104$. ILI is the only benchmark where DLinear's challenge is sharpest. With $n{=}966$ weekly samples and 7 channels, it is exactly the regime where a Transformer should over-fit.
